...
#define PYRO_SQUIB_PERIOD_DEFAULT				100
#define PYRO_SQUIB_PULSE_TIME_DEFAULT		90
#define PYRO_SQUIB_PULSES_NUM_DEFAULT		1

#define PYRO_SQUIB_CURRENT_DEFAULT	0.85

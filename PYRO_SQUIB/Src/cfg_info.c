...
const sConfigInfo configInfoHard = {
	...
	{	PYRO_SQUIB_PERIOD_DEFAULT,
		PYRO_SQUIB_PULSE_TIME_DEFAULT,
		PYRO_SQUIB_PULSES_NUM_DEFAULT,
		{DIG_POT_VALUE_MIN,	DIG_POT_VALUE_MAX, DIG_POT_CURRENT_MIN, DIG_POT_CURRENT_MAX},
